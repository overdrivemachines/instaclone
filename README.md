...
- Hashtags
- Saved Items
- In posts table add likes_count
- In users table add followers_count, followees_count columns
- Show number of likes for each comment. In comments table add likes_count.
